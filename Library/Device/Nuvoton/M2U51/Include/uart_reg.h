 ...
 * |        |          |Note 1: Refer to Figure 1.1-13Figure 1.1-13 and Figure 1.1-14Figure 1.1-14 for UART function mode.
 * |        |          |Note 2: Refer to Figure 1.1-17Figure 1.1-17 and Figure 1.1-18Figure 1.1-18 for RS-485 function mode.
 ...
 * |        |          |The detail description is shown in Table 1.1-4Table 1.1-4.
 ...
 * @var UART_T::AUTOCTL
 * Offset: 0x58  UART Automatic Operation Control Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[3:0]   |TRIGSEL   |Automatic Operation Trigger Source Select
 * |        |          |0000 = Low Power Auto-operation Trigger Source from TMR0.
 * |        |          |0001 = Low Power Auto-operation Trigger Source from TMR1.
 * |        |          |0010 = Low Power Auto-operation Trigger Source from TMR2.
 * |        |          |0011 = Low Power Auto-operation Trigger Source from TMR3.
 ...
 * |        |          |When TRIGEN (UART_AUTOCTL[4]) is set to '1', the automatic TX operation of UART will be triggered by an event sent from the trigger source selected by TRIGSEL[3:0].
 * |        |          |0 = UART Automatic Operation Trigger disabled.
 * |        |          |1 = UART Automatic Operation Trigger enabled.
 ...
 * |        |          |Note 1: When the system is in Power-down mode, Bus Idle Time-out event will wake-up system from Power-down mode if WKAOTOEN (UART_AUTOCTL[8]), AOEN (UART_AUTOCTL[31]), and TOCNTEN (UART_INTEN[11]) are all set to '1'.
 * |        |          |Note 2: When WKAOTOEN (UART_AUTOCTL[8]) is reset to '0', Bus Idle Time-out Wake-up event will not wake up the system
 * |        |          |Moreover, Bus Idle Time-out Wake-up event will gate the UART clock off if WKAOTOEN (UART_AUTOCTL[8]) and TRIGEN (UART_AUTOCTL[4]) are both reset to '0'.
 ...
 * @var UART_T::AUTOSTS
 * Offset: 0x5C  UART Automatic Operation Status Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * |        |          |Note 1: When RXPDMAEN (UART_INTEN[15]) or TXPDMAEN (UART_INTEN[14]) is enabled, this bit is the shadow bit of HWTOIF (UART_INTSTS[20]); user can read/clear it by reading/resetting HWTOIF (UART_INTSTS[20]) or AOTOWKF (UART_AUTOSTS[0]).
 * |        |          |Note 2: When RXPDMAEN (UART_INTEN[15]) and TXPDMAEN (UART_INTEN[14]) are both disabled, this bit is the shadow bit of RXTOIF (UART_INTSTS[4]); user can read/clear it by reading/resetting RXTOIF (UART_INTSTS[4]) or AOTOWKF (UART_AUTOSTS[0]).
 * |        |          |Note 3: If WKAOTOEN (UART_AUTOCTL[8]) is enabled, the Bus Idle Time-out Wake-up event will set this bit.
 ...
 */
    ...
    __IO uint32_t AUTOCTL;               /*!< [0x0058] UART Automatic Operation Control Register                        */
    __IO uint32_t AUTOSTS;               /*!< [0x005c] UART Automatic Operation Status Register                         */
...
#define UART_AUTOCTL_TRIGSEL_Pos         (0)                                               /*!< UART_T::AUTOCTL: TRIGSEL Position      */
#define UART_AUTOCTL_TRIGSEL_Msk         (0xful << UART_AUTOCTL_TRIGSEL_Pos)               /*!< UART_T::AUTOCTL: TRIGSEL Mask          */

#define UART_AUTOCTL_TRIGEN_Pos          (4)                                               /*!< UART_T::AUTOCTL: TRIGEN Position       */
#define UART_AUTOCTL_TRIGEN_Msk          (0x1ul << UART_AUTOCTL_TRIGEN_Pos)                /*!< UART_T::AUTOCTL: TRIGEN Mask           */

#define UART_AUTOCTL_CKAWOEN_Pos         (5)                                               /*!< UART_T::AUTOCTL: CKAWOEN Position      */
#define UART_AUTOCTL_CKAWOEN_Msk         (0x1ul << UART_AUTOCTL_CKAWOEN_Pos)               /*!< UART_T::AUTOCTL: CKAWOEN Mask          */

#define UART_AUTOCTL_WKAOTOEN_Pos        (8)                                               /*!< UART_T::AUTOCTL: WKAOTOEN Position     */
#define UART_AUTOCTL_WKAOTOEN_Msk        (0x1ul << UART_AUTOCTL_WKAOTOEN_Pos)              /*!< UART_T::AUTOCTL: WKAOTOEN Mask         */

#define UART_AUTOCTL_SWTRIG_Pos          (9)                                               /*!< UART_T::AUTOCTL: SWTRIG Position       */
#define UART_AUTOCTL_SWTRIG_Msk          (0x1ul << UART_AUTOCTL_SWTRIG_Pos)                /*!< UART_T::AUTOCTL: SWTRIG Mask           */

#define UART_AUTOCTL_AOEN_Pos            (31)                                              /*!< UART_T::AUTOCTL: AOEN Position         */
#define UART_AUTOCTL_AOEN_Msk            (0x1ul << UART_AUTOCTL_AOEN_Pos)                  /*!< UART_T::AUTOCTL: AOEN Mask             */

#define UART_AUTOSTS_AOTOWKF_Pos         (0)                                               /*!< UART_T::AUTOSTS: AOTOWKF Position      */
#define UART_AUTOSTS_AOTOWKF_Msk         (0x1ul << UART_AUTOSTS_AOTOWKF_Pos)               /*!< UART_T::AUTOSTS: AOTOWKF Mask          */

 ...
 */
    ...
    __IO uint32_t INT_EDETCTL;  /*!< [0x0490] INT Edge Detect Control Register                      */
    __I  uint32_t RESERVE1[1];
    __IO uint32_t INT_EDINTEN;  /*!< [0x0498] INT Edge Detect Interrupt Enable Control Register     */
    __IO uint32_t INT_EDSTS;    /*!< [0x049c] INT Edge Detect Interrupt Flag Register               */
    __I  uint32_t RESERVE2[24];
    __IO uint32_t AUTOCTL;      /*!< [0x0500] GPIO Auto-operation Control Register                  */
} GPIO_INT_T;
...
#define GPIO_SMTEN_SMTEN_Pos            (0)                                         /*!< GPIO_T::SMTEN: SMTEN Position              */
#define GPIO_SMTEN_SMTEN_Msk            (0xfffful << GPIO_SMTEN_SMTEN_Pos)          /*!< GPIO_T::SMTEN: SMTEN Mask                  */
...
#define GPIO_AUTOCTL_PAAUTOEN_Pos       (0)                                         /*!< GPIO_INT_T::AUTOCTL: PAAUTOEN Position         */
#define GPIO_AUTOCTL_PAAUTOEN_Msk       (0x1ul << GPIO_AUTOCTL_PAAUTOEN_Pos)        /*!< GPIO_INT_T::AUTOCTL: PAAUTOEN Mask             */

#define GPIO_AUTOCTL_PBAUTOEN_Pos       (1)                                         /*!< GPIO_INT_T::AUTOCTL: PBAUTOEN Position         */
#define GPIO_AUTOCTL_PBAUTOEN_Msk       (0x1ul << GPIO_AUTOCTL_PBAUTOEN_Pos)        /*!< GPIO_INT_T::AUTOCTL: PBAUTOEN Mask             */

#define GPIO_AUTOCTL_PCAUTOEN_Pos       (2)                                         /*!< GPIO_INT_T::AUTOCTL: PCAUTOEN Position         */
#define GPIO_AUTOCTL_PCAUTOEN_Msk       (0x1ul << GPIO_AUTOCTL_PCAUTOEN_Pos)        /*!< GPIO_INT_T::AUTOCTL: PCAUTOEN Mask             */

#define GPIO_AUTOCTL_PDAUTOEN_Pos       (3)                                         /*!< GPIO_INT_T::AUTOCTL: PDAUTOEN Position         */
#define GPIO_AUTOCTL_PDAUTOEN_Msk       (0x1ul << GPIO_AUTOCTL_PDAUTOEN_Pos)        /*!< GPIO_INT_T::AUTOCTL: PDAUTOEN Mask             */

#define GPIO_AUTOCTL_PEAUTOEN_Pos       (4)                                         /*!< GPIO_INT_T::AUTOCTL: PEAUTOEN Position         */
#define GPIO_AUTOCTL_PEAUTOEN_Msk       (0x1ul << GPIO_AUTOCTL_PEAUTOEN_Pos)        /*!< GPIO_INT_T::AUTOCTL: PEAUTOEN Mask             */

#define GPIO_AUTOCTL_PFAUTOEN_Pos       (5)                                         /*!< GPIO_INT_T::AUTOCTL: PFAUTOEN Position         */
#define GPIO_AUTOCTL_PFAUTOEN_Msk       (0x1ul << GPIO_AUTOCTL_PFAUTOEN_Pos)        /*!< GPIO_INT_T::AUTOCTL: PFAUTOEN Mask             */

#define GPIO_AUTOCTL_PGAUTOEN_Pos       (6)                                         /*!< GPIO_INT_T::AUTOCTL: PGAUTOEN Position         */
#define GPIO_AUTOCTL_PGAUTOEN_Msk       (0x1ul << GPIO_AUTOCTL_PGAUTOEN_Pos)        /*!< GPIO_INT_T::AUTOCTL: PGAUTOEN Mask             */

#define GPIO_AUTOCTL_PHAUTOEN_Pos       (7)                                         /*!< GPIO_INT_T::AUTOCTL: PHAUTOEN Position         */
#define GPIO_AUTOCTL_PHAUTOEN_Msk       (0x1ul << GPIO_AUTOCTL_PHAUTOEN_Pos)        /*!< GPIO_INT_T::AUTOCTL: PHAUTOEN Mask             */

#define GPIO_AUTOCTL_PDMAAOEN_Pos       (31)                                        /*!< GPIO_INT_T::AUTOCTL: PDMAAOEN Position         */
#define GPIO_AUTOCTL_PDMAAOEN_Msk       (0x1ul << GPIO_AUTOCTL_PDMAAOEN_Pos)        /*!< GPIO_INT_T::AUTOCTL: PDMAAOEN Mask             */

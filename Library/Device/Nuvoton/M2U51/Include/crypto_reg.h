...
typedef struct
{
    ...
    __I  uint32_t RESERVE2[913];
    __I  uint32_t AHB_STS;               /*!< [0x0f90] CRPT AHB Master Status Register                                */
...
#define CRPT_AHB_STS_BUSY_Pos          (0)                                               /*!< CRPT_T::AHB_STS: BUSY Position       */
#define CRPT_AHB_STS_BUSY_Msk          (0x1ul << CRPT_AHB_STS_BUSY_Pos)                  /*!< CRPT_T::AHB_STS: BUSY Mask           */

#define CRPT_AHB_STS_SERVICE_Pos       (1)                                               /*!< CRPT_T::AHB_STS: SERVICE Position    */
#define CRPT_AHB_STS_SERVICE_Msk       (0x7ul << CRPT_AHB_STS_SERVICE_Pos)               /*!< CRPT_T::AHB_STS: SERVICE Mask        */

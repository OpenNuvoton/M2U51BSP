 ...
 * @file     timer.c
 * @version  V1.00
 * @brief    M2U51 Timer Controller (Timer) driver source file
 *
...
/**
  ...
  * @param[in] u32DropCount This parameter has no effect in M2U51 series BSP
  * @param[in] u32Timeout   This parameter has no effect in M2U51 series BSP
...
/**
  ...
  *
  * @param[in] timer    The base address of Timer module
  * @param[in] u32Mask  The mask of modules trigger by timer. Is the combination of
...
/**
  ...
  * @param[in] timer    The base address of Timer module
  * @param[in] u32Src   Selects the interrupt source to trigger other modules. Could be:
  *                     - \ref TIMER_ATRGSRC_TIMEOUT_EVENT
  *                     - \ref TIMER_ATRGSRC_CAPTURE_EVENT
  *
  * @return None
  */
...
/**
  ...
  *
  * @param[in] timer    The base address of Timer module
  * @param[in] u32Mask  The mask of modules (PDMA and other IPs) trigger by timer. Is the combination of
  *                     - \ref TIMER_ATRG_TO_IPS
  *                     - \ref TIMER_ATRG_TO_PDMA
  *
  * @return None
  */
...
/**
  ...
  * @return     None
  *
  * @details    This API is used to select timer capture source from TMx_EXT or internal signal.
  */

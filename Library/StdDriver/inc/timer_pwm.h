...
/*---------------------------------------------------------------------------------------------------------*/
/*  TPWM Trigger ADC/PDMA Source Select Constant Definitions                                          */
/*---------------------------------------------------------------------------------------------------------*/
#define TPWM_TRIGGER_AT_PERIOD_POINT            (0UL << TIMER_PWMTRGCTL_TRGSEL_Pos) /*!< Timer PWM trigger ADC/PDMA while counter period point event occurred \hideinitializer */
#define TPWM_TRIGGER_AT_COMPARE_POINT           (1UL << TIMER_PWMTRGCTL_TRGSEL_Pos) /*!< Timer PWM trigger ADC/PDMA while counter compare point event occurred \hideinitializer */
#define TPWM_TRIGGER_AT_PERIOD_OR_COMPARE_POINT (2UL << TIMER_PWMTRGCTL_TRGSEL_Pos) /*!< Timer PWM trigger ADC/PDMA while counter period or compare point event occurred \hideinitializer */
...
/**
  ...
  */
#define TPWM_EnableTriggerADC(timer, u32Condition)  TPWM_EnableTrigger(timer, TIMER_PWMTRGCTL_PWMTRGADC_Msk, u32Condition)
...
/**
  ...
  */
#define TPWM_DisableTriggerADC(timer)               TPWM_DisableTrigger(timer, TIMER_PWMTRGCTL_PWMTRGADC_Msk)

 ...
 * @file     acmp.h
 * @version  V1.00
 * @brief    M2U51 Series ACMP Driver Header File
 *
...
/**
  ...
  * \hideinitializer
  */
#define ACMP_DISABLE_HYSTERESIS(acmp, u32ChNum) ((acmp)->CTL[(u32ChNum)] = ((acmp)->CTL[(u32ChNum)] & ~ACMP_CTL_HYSSEL_Msk) | (ACMP_CTL_HYSTERESIS_DISABLE)

 ...
 * @file     timer.h
 * @version  V1.00
 * @brief    M2U51 series Timer Controller (Timer) Driver Header File
 *
...
/*--------------------------------------------------------------------------*/
/*  TIMER Operation Mode Constant Definitions                               */
/*--------------------------------------------------------------------------*/
...
/*--------------------------------------------------------------------------*/
/*  TIMER External Counter Mode Constant Definitions                        */
/*--------------------------------------------------------------------------*/
...
#define TIMER_COUNTER_FALLING_EDGE              (TIMER_COUNTER_EVENT_FALLING)
#define TIMER_COUNTER_RISING_EDGE               (TIMER_COUNTER_EVENT_RISING)

/*--------------------------------------------------------------------------*/
/*  TIMER Capture Mode Constant Definitions                                 */
/*--------------------------------------------------------------------------*/
...
#define TIMER_CAPTURE_FALLING_EDGE              (TIMER_CAPTURE_EVENT_FALLING)
#define TIMER_CAPTURE_RISING_EDGE               (TIMER_CAPTURE_EVENT_RISING)
#define TIMER_CAPTURE_FALLING_AND_RISING_EDGE   (TIMER_CAPTURE_EVENT_FALLING_RISING)

#define TIMER_CAPSRC_TMX_EXT                    (0UL << TIMER_CTL_CAPSRC_Pos)       /*!< Capture source from TMx_EXT pin      \hideinitializer */
#define TIMER_CAPSRC_INTERNAL                   (1UL << TIMER_CTL_CAPSRC_Pos)       /*!< Capture source from Internal event such as LXT/HIRC/LIRC/MIRC or ACMP0/1  \hideinitializer */
...
#define TIMER_TRG_TO_ADC                        (TIMER_TRGCTL_TRGADC_Msk)           /*!< Each timer event to start ADC conversion \hideinitializer */
#define TIMER_TRG_TO_PDMA                       (TIMER_TRGCTL_TRGPDMA_Msk)          /*!< Each timer event to trigger PDMA transfer \hideinitializer */

/*--------------------------------------------------------------------------*/
/*  TIMER Auto Operation Mode Constant Definitions                          */
/*--------------------------------------------------------------------------*/
#define TIMER_ATRGSRC_TIMEOUT_EVENT             (0UL << TIMER_ATRGCTL_ATRGSSEL_Pos) /*!< Select auto operation internal trigger source from timer time-out event \hideinitializer */
#define TIMER_ATRGSRC_CAPTURE_EVENT             (1UL << TIMER_ATRGCTL_ATRGSSEL_Pos) /*!< Select auto operation internal trigger source from timer capture event \hideinitializer */

#define TIMER_ATRG_TO_IPS                       (TIMER_ATRGCTL_ATRGEN_Msk)          /*!< Each auto operation timer event to trigger IPs \hideinitializer */
#define TIMER_ATRG_TO_PDMA                      (TIMER_ATRGCTL_ATRGPDMA_Msk)        /*!< Each auto operation timer event to trigger PDMA transfer \hideinitializer */
...
__STATIC_INLINE void TIMER_EnableWakeup(TIMER_T *timer)
{
    timer->CTL |= (TIMER_CTL_WKEN_Msk | TIMER_CTL_PDCLKEN_Msk);
}
...
void     TIMER_SetATriggerSource  (TIMER_T *timer, uint32_t u32Src);
void     TIMER_SetATriggerTarget  (TIMER_T *timer, uint32_t u32Mask);

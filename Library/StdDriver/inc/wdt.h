 ...
 * @file     wdt.h
 * @version  V3.00
 * @brief    M2U51 series WDT driver header file
 *
...
/**
  ...
  * \hideinitializer
  */
#define WDT_CLEAR_RESET_FLAG()          (WDT->STATUS = (WDT->STATUS & ~(WDT_STATUS_IF_Msk | WDT_STATUS_WKF_Msk)) | WDT_STATUS_RSTF_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define WDT_CLEAR_TIMEOUT_INT_FLAG()    (WDT->STATUS = (WDT->STATUS & ~(WDT_STATUS_RSTF_Msk | WDT_STATUS_WKF_Msk)) | WDT_STATUS_IF_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define WDT_CLEAR_TIMEOUT_WAKEUP_FLAG() (WDT->STATUS = (WDT->STATUS & ~(WDT_STATUS_RSTF_Msk | WDT_STATUS_IF_Msk)) | WDT_STATUS_WKF_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define WDT_GET_RESET_FLAG()            ((WDT->STATUS & WDT_STATUS_RSTF_Msk)? 1UL : 0UL)
...
/**
  ...
  * \hideinitializer
  */
#define WDT_GET_TIMEOUT_INT_FLAG()      ((WDT->STATUS & WDT_STATUS_IF_Msk)? 1UL : 0UL)
...
/**
  ...
  * \hideinitializer
  */
#define WDT_GET_TIMEOUT_WAKEUP_FLAG()   ((WDT->STATUS & WDT_STATUS_WKF_Msk)? 1UL : 0UL)
